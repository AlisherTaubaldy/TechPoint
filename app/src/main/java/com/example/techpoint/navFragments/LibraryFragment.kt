...
class LibraryFragment : Fragment(), BookOnClickListener {
    ...
    lateinit var listener: BookOnClickListener
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.recyclerView.adapter = LibraryAdapter(requireContext(), cours, listener)
    ...
    override fun bookOnClick(view: View, manga: BookDataSet) {
        Log.d(TAG, "bookOnClick: hello$manga")
    }
